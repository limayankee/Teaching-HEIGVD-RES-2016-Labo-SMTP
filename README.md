...
### The goal of the project
  ...
  The goal of this project is to make a Java application that will send mails to preset victims email address. The software will automatically generate groups of victims, of minimum 3 persons, one sender and two or more receivers. The software user can choose how many groups he wants.
